      ...
      <main className="container px-4 py-8 mx-auto">
        <section className="mb-8 text-center">
          ...
          <ul className="grid flex-col grid-cols-1 gap-8 p-4 mb-4 bg-gray-900 rounded-lg sm:grid-cols-4 justify-evenly">
            <li>
              <MyButton
                onClick={() => setContent("Cambios Generales - General.html")}>
                General
              </MyButton>
            </li>
            <li>
              <MyButton onClick={() => setContent("Evento - Event.html")}>
                Event
              </MyButton>
            </li>
            <li>
              <MyButton
                onClick={() =>
                  setContent("Actualizaciones de la Tienda - Store.html")
                }>
                Store
              </MyButton>
            </li>
          ...
          {isClassMenuVisible && (
            <>
              ...
              <div
                ref={classMenuRef}
                className="grid flex-col grid-cols-1 gap-8 p-4 mb-4 bg-gray-900 rounded-lg sm:grid-cols-4 justify-evenly">
                <MyButton onClick={() => router.push("/guidebalance")}>
                  Siegel Knight
                </MyButton>
                <MyButton onClick={() => router.push("/guidebalance")}>
                  Tyrr Warrior
